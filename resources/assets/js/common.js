$(function() {
    ...
    function productSlider() {
        if ($(".section--product-slider").length > 0) {
            ...
            $('.product-slider__tabs-list>li>a').click(function(e) {
                ...
                $(tabgroup).children('.product-slider__tabgroup-item').hide();
                $(target).show();
    ...
    if ($(".section--product-slider").length > 0) {
        $(".product-slider__tabgroup-item").owlCarousel({
            ...
            dots: true,
            loop: true,
            navText: ['<i class="fa fa-angle-left" aria-hidden="true"></i>', '<i class="fa fa-angle-right fa-2" aria-hidden="true"></i>'],
            responsive: {
                320: {
                    items: 2,
