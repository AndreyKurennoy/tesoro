<header class="header">
        <div class="header__modal">
            ...
            <div class="header__modal-menu">
                <ul class="header__modal-menu-items">
                    <li>
                ...
                <ul class="header__modal-menu-social_lang">
                    <li>
                ...
                <ul class="header__modal-menu-func">
                    <li>
                        <a href="#">Каталог</a>
                    </li>
                    <li>
        ...
        <div class="header__middle">
            ...
            <div class="header__middle-left">
                ...
                <div class="header__middle-funcset">
                    <a class="header__middle-funcset-catalog" href="#">
                        <i class="fa fa-list" aria-hidden="true"></i>
                        <span>Каталог</span>
                    </a>
                    <a class="header__middle-funcset-match" href="#">
                        <i class="fa fa-align-center" aria-hidden="true"></i>
                        <span>Подбор</span>
                    </a>
                    <a class="header__middle-funcset-search" href="#">
            ...
            <div class="header__middle-right">
                <div class="header__middle-tell">
                    <a href="tel:+1234567890">
                        <i class="fa fa-phone" aria-hidden="true"></i>
                        <span>(063) 234 59 99</span>
                        <p>Обратный звонок</p>
                    </a>
                </div>
                <div class="header__middle-address">
                    <a href="#">Адрес
        ...
        <nav class="header__bottom">
            <ul class="header__bottom-menu owl-carousel owl-theme">
                <li>
                    <a href="#">бренды</a>
                </li>
                <li>
                ...
                <li>
                    <a href="#">аксессуары для мужчин</a>
                </li>
                <li>
                    <a href="#">золотые украшения</a>
                </li>
                <li>
                    <a href="#">серебрянные украшения</a>
                </li>
            </ul>
        </nav>
    </header>
